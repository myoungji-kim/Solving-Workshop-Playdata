...
public class EmpDAO {
	public List <EmpDTO> selectAll(Connection con){
		...
		ResultSet rs = null;
		String sql = "select empno as 사원번호, ename, sal, TO_CHAR(hiredate, 'YYYY/MM/DD') as hiredate, deptno, mgr, job from emp";
...
/*	public EmpDTO selectByDeptno(Connection con, int deptno) {
	...
	public int insert(Connection con, EmpDTO dto) {
		...
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = "insert into emp (empno, ename, sal, hiredate, job, mgr) values (?,?,?,?,?,?)";
